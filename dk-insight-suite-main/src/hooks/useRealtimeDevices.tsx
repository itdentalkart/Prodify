...
export interface RealtimeDevice extends DeviceRow {
  profiles?: {
...
export function useRealtimeDevices() {
  ...
  const fetchDevices = async () => {
    ...
    try {
      ...
      const devicesWithProfiles: RealtimeDevice[] = (devicesData || []).map(device => ({
        ...device,
  ...
  return { devices, loading, lastUpdate, refetch: fetchDevices };
}
